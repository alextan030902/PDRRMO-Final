...
<main class="main">
    ...
    <!-- Modal for deleting images from the carousel -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="#" method="POST" id="carouselDeleteForm">
                        @csrf
                        @method('DELETE')
                        <div id="deleteImagesContainer"></div> <!-- Will hold the list of selected images to delete -->
